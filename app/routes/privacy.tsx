	...
	return (
		<main style={{ maxWidth: 720, margin: "0 auto", padding: "2.5rem 1.5rem" }}>
			...
			<section style={{ marginBottom: "1.5rem" }}>
				...
				<ul>
					<li>
						Información de la tienda (por ejemplo, dominio y configuración del
						bloque de la app).
					</li>
					<li>
						Datos técnicos necesarios para operar la app (tokens de sesión y
						registros de actividad).
					</li>
					<li>
						No recopilamos datos personales de los compradores finales.
					</li>
				</ul>
			</section>
			...
			<section style={{ marginBottom: "1.5rem" }}>
				...
				<p>
					No vendemos ni compartimos la información de tu tienda con terceros,
					excepto cuando sea necesario para operar la app (por ejemplo, con
					Shopify) o cuando la ley lo requiera.
				</p>
			</section>
